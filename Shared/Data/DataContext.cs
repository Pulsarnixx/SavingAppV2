...
namespace Webapp.Shared.Data
{
    public class DataContext : DbContext
    {
        ...
        modelBuilder.Entity<SavingEntity>().HasData(
            ...
            new {Id = 2, Category = SavingCategory.Other, Name = "Mydło", Amount = 5.00m, Date = DateTime.Now},
            new {Id = 3, Category = SavingCategory.Other, Name = "Plecak", Amount = 1.00m, Date = DateTime.Now}
        );
    }
    }
}